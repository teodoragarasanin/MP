...
extension CGRect {
    ...
    var  upperLeft: CGPoint {return CGPoint(x:midX, y:midY)}
    var  lowerLeft: CGPoint {return CGPoint(x:midX, y:midY)}
    var  upperRight: CGPoint {return CGPoint(x:midX, y:midY)}
    var  lowerRight: CGPoint {return CGPoint(x:midX, y:midY)}
